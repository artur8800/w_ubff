...
<footer class="section page__footer">
    <div class="desktop__footer">
        <div class="container">
            <div class="row">
                <div class="col s2 m4 l5 xl5">
                    <div class="footer__left">
                        <div class="footer__logo">
                            <?php the_custom_logo(); ?>
                        </div>
                        <div class="footer__text">
                            <span class="copyrights copyrights-text">Українська ВМХ Фристайл Федерація<br></span>
                            <span class="copyrights-text">Усі права захищіні</span>
                        </div>
                        <ul class="icons__list">
                            <li class="icons__list__item">
                                <a class="icon__button svg__button">
                ...
                <div class="col s2 m4 l4 xl4">
                    <div class="footer__center">
                        <h4 class="footer__heading">Роздiли</h4>

                        <!-- <li class="footer__navigation__item"><a class="footer__navigation__link navigation__link"
                                    href="">Новини</a>
                            </li> -->
						...
						if( $locations && isset( $locations[ $menu_name ] ) ){
							...
							$menu_list = '<ul id="footer__navigation__list clearfix">';
						
							foreach ( (array) $menu_items as $key => $menu_item ){
							
								$menu_list .= '<li class="footer__navigation__item"><a class="footer__navigation__link navigation__link" href="' . $menu_item->url . '">' . $menu_item->title . '</a></li>';
                ...
                <div class="col l3 xl3 hide-on-small">
                    <div class="footer__right">
                        <div class="footer__right__wrapper">
                            <h4 class="footer__heading">Вступ</h4>
                            <a href="#" class="button__rounded button-blue">Долучитися до федераціi</a>
                        </div>
                    </div>
                </div>
            </div>
